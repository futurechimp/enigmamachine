...
Enigmamachine should be set to bind by default to 127.0.0.1 (your system's loopback)
interface.  However, the Thin webserver in the rackup file is currently making
itself available at IP 0.0.0.0, meaning it'll be available on all network
interfaces (unless you're running a firewall).
...
talk to ffmpeg is a simple exec call and you'll be inviting everyone to
...
eats your mother. I'm working on the security and will have updates ready soon.
